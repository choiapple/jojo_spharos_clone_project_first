  ...
  return (
    <div className="mndtl_sec_bx">
      <div className="mndtl_rectit_tytext">
        <a href="/disp/category.ssg?ctgId=6000211238&amp;_mpop=new" className="mndtl_rectit_text" target="_parent">
          <span className="mndtl_rectit_text_tx clickable">
            함께 보면 좋은 상품
          </span>
          <span className="mndtl_rectit_arrow">
            <span className="blind">더보러가기</span>
            <i className="mndtl_ic_arr clickable"></i>
          </span>
        </a>
            ...
            <div className="mnsditem_unit">
              ...
              <div className="mnsditem_goods">
                <div className="mnsditem_thmb">
                  <a href="/item/itemView.ssg?itemId=1000057900457&amp;siteNo=6004&amp;salestrNo=6005&amp;click=itemMidArea02"
                    className="mnsditem_thmb_link clickable" target="_parent">
                    <div className="mnsditem_thmb_imgbx">
                      <img src="//sitem.ssgcdn.com/57/04/90/item/1000057900457_i1_187.jpg" alt="토미 G1"
                        className="ssg_lazy mnsditem_thmb_img" />
                    </div>
                  </a>
                  <div className="mnsditem_thmb_ctrl">
                    <a href="https://m.ssg.com/search/image/main.ssg?searchType=img&amp;itemId=1000057900457&amp;src_area=ssglens"
                  ...
                  <div className="mnsditem_btn_like">
                    <span className="cmlike _js_cmlike interestIt">
                      ...
                      <input type="hidden" name="attnTgtIdnfNo1" value="1000057900457" />
