          ...
          <div className="mndtl_recommend">
            <div className="mndtl_sec_bx">
              ...
              <div className="cmitem_grid">
                <ul id="infinite-container" className="cmitem_grid_lst mnsditem_ty_thmb">
                  {/* 여기서부터 반복 */}
                    ...
                    <div className="mnsditem_unit">
                      ...
                      <div className="mnsditem_goods">
                        <div className="mnsditem_thmb">
                          <a href="https://m-premiumoutlets.ssg.com/item/itemView.ssg?itemId=1000362395822&amp;siteNo=7008&amp;salestrNo=6005&amp;click=itemMidArea15"
                            className="mnsditem_thmb_link clickable" target="_parent">
                            <div className="mnsditem_thmb_imgbx">
                              <img src="//sitem.ssgcdn.com/57/04/90/item/1000057900457_i1_187.jpg"
                          ...
                          <div className="mnsditem_thmb_ctrl">
                            <a href="https://m.ssg.com/search/image/main.ssg?searchType=img&amp;itemId=1000362395822&amp;src_area=ssglens"
                              className="mnsditem_btn_lens clickable" target="_parent">
                          ...
                          <div className="mnsditem_btn_like">
                            <span className="cmlike _js_cmlike interestIt">
                              ...
                              <input type="hidden" name="attnTgtIdnfNo1" value="1000362395822" />
                              <input type="hidden" name="attnTgtIdnfNo2" value="6005" />
                              <input type="hidden" name="uitemId" value="00001" />
                              <input type="hidden" name="notiTitle" value="[파주점] 레이밴 선글라스 RB3595 9013/13" />
                        ...
                        <div className="mnsditem_detail">
                          <div className="mnsditem_maininfo">
                            <a href="https://m-premiumoutlets.ssg.com/item/itemView.ssg?itemId=1000362395822&amp;siteNo=7008&amp;salestrNo=6005&amp;click=itemMidArea15"
                              className="mnsditem_maininfo_link" target="_parent">
