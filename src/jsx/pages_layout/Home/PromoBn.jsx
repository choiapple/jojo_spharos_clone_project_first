        ...
        <div className="cmgrid_full_box" data-page-set-id="116">
            <div className="cmbnr_promo">
                <div className="cmbnr_promo_bn">
                    <a href="https://m-shinsegaemall.ssg.com/page/dept/home.ssg?ldt=menu&amp;mccode=6009"
                        className="cmbnr_lnk clickable" data-react-tarea="홈|신세계백화점랜딩배너|배너_클릭|백화점 배너">
                        <span className="cmbnr_img">
                            <img className="ssg_lazy loaded"
                                ...
                                alt="백화점 배너" data-ll-status="loaded" />
                        </span>
                    </a>
                </div>
            </div>
