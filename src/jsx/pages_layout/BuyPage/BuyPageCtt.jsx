...
function BuyPageCtt({pdtDetail,selectedData}) {
  ...
  let fullDate7 = `${year}-0${month}-0${date + 7}`
    ...
    const imgList = pdtDetail.productPhotoList
    const imgUrl = imgList[0].productPhotoPath
    ...
    const goodOrder = ()=>{
        Swal.fire({
          title: '결제가 완료되었습니다 !',  
              text: `${userData.name}님 안전하게 배송해드릴게요 `,
              icon: 'success'
        })
      }
    ...
    const handleOrder = () =>{
        if(auth.auth === true){
            ...
            axios.post(`${Server.baseUrl}api/orders/add`,{
                    "ordersPrice":totalNewPrice,
                    "ordersName":userData.name,
                    "ordersPhone":userData.phone,
                    "ordersEmail":userData.email,
                    "deliveryDate":fullDate,
                    "deliveryRequest":"배송 전 연락주세요",
                    "deliveryAddress":userDelivery.id,
                    "ordersProductListAddDtoList":selectedData
                    },
                    {
                        headers:
                        {
                ...
                <div id="m_content" className="m_content ty_bg">
                    <form id="orderForm" name="orderForm" method="post" action="/m/order/orderProcessNew.ssg">
                        ...
                        <div id="divOrdArea">
                                            ...
                                            <div className="mnodr_form_sec">
                                                ...
                                                <div className="mnodr_tx_wrap ty_space">
                                                    <span className="mnodr_tx_size2 mnodr_tx_gray">
                                                        <span id="dispRcptpeNm_0">{userData.name}</span>
                                                        /
                                                        <span id="dispHpno_0">{userData.phone}</span>
                                                    </span>
                                                    <span className="mnodr_chk">
                                ...
                                <div className="mnodr_article_cont ty_pull">
                                    <div className="mnodr_form_sec">
                                        <dl className="mnodr_priceitem ty_narrow">
                                            ...
                                            <dd>
                                                <span className="mnodr_tx_primary">+ <em
                                                        className="ssg_price dispTotPayOrdAmt">{totalNewPrice.toLocaleString()}</em><span
                                                        className="ssg_tx">원</span></span>
                                            </dd>
                                        </dl>
                                        <dl className="mnodr_priceitem ty_narrow">
                                            ...
                                            <dd>
                                                <span className="mnodr_tx_point">- <em
                                                        className="ssg_price dispTotDcAmt">0</em><span
                                                        className="ssg_tx">원</span></span>
                                            </dd>
                                        </dl>
                                        ...
                                        <dl className="mnodr_priceitem ty_narrow">
                                            ...
                                            <dd>
                                                <span className="mnodr_tx_primary">+<em
                                                        className="ssg_price paySummaryTotOrdCstAmt">0</em><span
                                                        className="ssg_tx">원</span></span>
                                            </dd>
                                        </dl>
                                        ...
                                        <dl className="mnodr_priceitem ty_total">
                                            ...
                                            <dd>
                                                <strong className="mnodr_tx_primary mnodr_priceitem_total v2">
                                                    +
                                                    <em
                                                        className="ssg_price paySummaryPayAmt paySummaryTgtPaymtAmt">{totalNewPrice.toLocaleString()}</em><span
                                                        className="ssg_tx">원</span>
                                                </strong>
                                            </dd>
                                        </dl>
                                                    ...
                                                    <div className="mnodr_unit_item">
                                                        <div className="mnodr_unit_thmb">
                                                            <span className="mnodr_unit_img" aria-hidden="true">
                                                                <img src={imgUrl} alt="JMW 매직컬 W2010ME 무빙쿠션 고데기"
                                                                    width="85" height="85" />
                                                            </span>
                                                        </div>
                                                        <div className="mnodr_unit_cont">
                                                            <div className="mnodr_unit_info ty2">
                                                                ...
                                                                <em id="dispSalestrNm_1"> {pdtDetail.manufactureCompany}
                                                                </em>
                                                            </div>
                                                            <p className="mnodr_unit_tit">
                                                                <a>
                                                                    <strong className="mnodr_unit_brd">JMW </strong>
                                                            ...
                                                            <span className="mnodr_unit_option mnodr_tx_point"
                                                                id="shppRsvtType_1_1_50_" style={{display: "none"}}>
                                                            </span>
                                                                ...
                                                                <div className="mnodr_unit_l">
                                                                    <div className="mnodr_unit_newprice ty2">
                                                                        <span className="blind">판매가격</span><em
                                                                            className="ssg_price">{totalNewPrice.toLocaleString()}</em><span
                                                                            className="ssg_tx">원</span>
                                                                    </div>
                                                                </div>
                                                                <div className="mnodr_unit_r">
                                                                    <span className="mnodr_unit_option"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div className="mnodr_toolbar2" id="divOrdToolbar" onClick={handleOrder}>
                                <div className="mnodr_btn_area">
