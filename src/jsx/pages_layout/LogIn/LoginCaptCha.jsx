...
function LoginCaptCha() {
    return ( 
        <div className="cmem_captcha" id="captcha_area" style={{display:'none'}}>
            ...
            <div className="cmem_inp_txt2">
                <label ><span className="blind">자동입력 방지문자</span></label>
                <input type="text" id="inp_autonot" name="captcha_response" placeholder="자동입력 방지문자" />
                <button type="button" className="inp_clear">
                    <span className="sp_cmem_login cmem_ico_clear"><span className="blind">입력내용
                            삭제</span></span>
                </button>
